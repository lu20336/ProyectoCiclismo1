...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const registroLink = $id("registroLink");
    const logoutButton = $id("logout");
    const authContainer = $id("authContainer");
    const authButton = $id("authButton");
    const toggleAuth = $id("toggleAuth");
    const authTitle = $id("authTitle");
    const extraFields = $id("extraFields");
    ...
    authButton.addEventListener("click", function () {
        ...
        if (isRegistering) {
            const nombreCompleto = $id("nombreCompleto").value;
            const telefono = $id("telefono").value;
            const ciudad = $id("ciudad").value;
...
$id("formRegistro").addEventListener("submit", function (event) {
    event.preventDefault();

    let nombre = $id("nombre").value;
    let email = $id("email").value;
    let telefono = $id("telefono").value;
    let curso = $id("curso").value;
